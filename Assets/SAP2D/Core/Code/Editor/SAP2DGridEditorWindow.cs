...
namespace SAP2D.Editors
{
    public class SAP2DGridEditorWindow : EditorWindow
    {
        ...
        {
            string path = "Assets/SAP2D/Core/Code/Editor/GUI/Icons/"; 
            int iconStyle = (EditorGUIUtility.isProSkin) ? 1 : 0;

            GUIContent[] toolbarContent = new GUIContent[4]
            {
                new GUIContent(AssetDatabase.LoadAssetAtPath<Texture2D>(path + "pencil_icon"+iconStyle+".png"), "Pencil Tool \n\nShortcut: 'Shift + A'"),
                new GUIContent(AssetDatabase.LoadAssetAtPath<Texture2D>(path + "rubber_icon"+iconStyle+".png"), "Rubber Tool \n\nShortcut: 'Shift + S'"),
                new GUIContent(AssetDatabase.LoadAssetAtPath<Texture2D>(path + "rectangle_icon"+iconStyle+".png"), "Rectangle Tool \n\nShortcut: 'Shift + D'"),
                new GUIContent(AssetDatabase.LoadAssetAtPath<Texture2D>(path + "settings_icon"+iconStyle+".png"), "General Settings")
            };
        ...
        private void LoadGuiSkin()
        {
            ...
            customGUISkin = AssetDatabase.LoadAssetAtPath<GUISkin>("Assets/SAP2D/Core/Code/Editor/GUI/SAP2DGridEditor" + skinSyle + ".guiskin");
        }
    }
}